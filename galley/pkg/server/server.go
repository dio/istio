...
import (
	...
	mcpSource "istio.io/istio/galley/pkg/source/mcp"
...
type patchTable struct {
	...
	mcpSourceNew                func(ctx context.Context, mcpAddress, nodeID string) (runtime.Source, error)
}
